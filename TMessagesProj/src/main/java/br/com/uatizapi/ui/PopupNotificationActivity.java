...
import br.com.uatizapi.ui.Views.FrameLayoutFixed;
import br.com.uatizapi.ui.Views.PopupAudioView;
...
public class PopupNotificationActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(br.com.uatizapi.messenger.R.layout.popup_notification_layout);
        RelativeLayout popupContainer = (RelativeLayout) findViewById(br.com.uatizapi.messenger.R.id.popup_container);
        ...
        actionBarLayer.setBackgroundResource(br.com.uatizapi.messenger.R.color.header);
        actionBarLayer.setItemsBackground(br.com.uatizapi.messenger.R.drawable.bar_selector);
        actionBar.setCurrentActionBarLayer(actionBarLayer);

        ActionBarMenu menu = actionBarLayer.createMenu();
        View view = menu.addItemResource(2, br.com.uatizapi.messenger.R.layout.popup_count_layout);
        countText = (TextView) view.findViewById(br.com.uatizapi.messenger.R.id.count_text);

        view = menu.addItemResource(1, br.com.uatizapi.messenger.R.layout.chat_header_layout);
        avatarImageView = (BackupImageView)view.findViewById(br.com.uatizapi.messenger.R.id.chat_avatar_image);
        ...
        chatActivityEnterView.setContainerView(this, findViewById(br.com.uatizapi.messenger.R.id.chat_layout));
    ...
    private ViewGroup getViewForMessage(int num, boolean applyOffset) {
        ...
        if (messageObject.type == 1) {
            if (imageViews.size() > 0) {
                ...
                view.addView(getLayoutInflater().inflate(br.com.uatizapi.messenger.R.layout.popup_image_layout, null));
                view.setTag(2);
            ...
            TextView messageText = (TextView)view.findViewById(br.com.uatizapi.messenger.R.id.message_text);
            BackupImageView imageView = (BackupImageView) view.findViewById(br.com.uatizapi.messenger.R.id.message_image);
            ...
            if (audioViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                view.addView(getLayoutInflater().inflate(br.com.uatizapi.messenger.R.layout.popup_audio_layout, null));
                view.setTag(3);
                ...
                ViewGroup audioContainer = (ViewGroup)view.findViewById(br.com.uatizapi.messenger.R.id.audio_container);
            ...
            if (textViews.size() > 0) {
                ...
                view = new FrameLayoutAnimationListener(this);
                view.addView(getLayoutInflater().inflate(br.com.uatizapi.messenger.R.layout.popup_text_layout, null));
                view.setTag(1);

                View textContainer = view.findViewById(br.com.uatizapi.messenger.R.id.text_container);
