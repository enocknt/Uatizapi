...
public class ChatBaseCell extends BaseCell {
    ...
    public ChatBaseCell(Context context) {
        ...
        if (backgroundDrawableIn == null) {
            backgroundDrawableIn = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_in);
            backgroundDrawableInSelected = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_in_selected);
            backgroundDrawableOut = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_out);
            backgroundDrawableOutSelected = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_out_selected);
            backgroundMediaDrawableIn = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_in_photo);
            backgroundMediaDrawableInSelected = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_in_photo_selected);
            backgroundMediaDrawableOut = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_out_photo);
            backgroundMediaDrawableOutSelected = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_out_photo_selected);
            checkDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_check);
            halfCheckDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_halfcheck);
            clockDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_clock);
            checkMediaDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_check_w);
            halfCheckMediaDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_halfcheck_w);
            clockMediaDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_clock_photo);
            errorDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.msg_warning);
            mediaBackgroundDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.phototime);
            broadcastDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.broadcast3);
            broadcastMediaDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.broadcast4);
    ...
    public void setMessageObject(MessageObject messageObject) {
        ...
        if (drawForwardedName && messageObject.messageOwner instanceof TLRPC.TL_messageForwarded) {
            ...
            if (currentForwardUser != null) {
                ...
                str = Html.fromHtml(String.format("%s<br>%s <b>%s</b>", LocaleController.getString("ForwardedMessage", br.com.uatizapi.messenger.R.string.ForwardedMessage), LocaleController.getString("From", br.com.uatizapi.messenger.R.string.From), str));
