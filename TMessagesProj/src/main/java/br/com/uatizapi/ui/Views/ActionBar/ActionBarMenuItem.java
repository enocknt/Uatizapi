...
public class ActionBarMenuItem extends ImageView {
    ...
    public void addSubItem(int id, String text, int icon) {
        if (popupLayout == null) {
            ...
            popupLayout.setBackgroundResource(br.com.uatizapi.messenger.R.drawable.popup_fixed);
        ...
        textView.setBackgroundResource(br.com.uatizapi.messenger.R.drawable.list_selector);
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        if (value && searchField == null) {
            ...
            searchField.setBackgroundResource(br.com.uatizapi.messenger.R.drawable.search_light_states);
        ...
        if (img != null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, br.com.uatizapi.messenger.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
