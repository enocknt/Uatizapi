...
public class ActionBarLayer extends FrameLayout {
    ...
    public ActionBarMenu createActionMode() {
        ...
        actionMode.setBackgroundResource(br.com.uatizapi.messenger.R.drawable.editheader);
        addView(actionMode);
    ...
    protected void onSearchFieldVisibilityChanged(boolean visible) {
        ...
        if (visible) {
            ...
            setDisplayUseLogoEnabled(true, br.com.uatizapi.messenger.R.drawable.ic_ab_search);
        } else {
        ...
        if (visible) {
            ...
            setDisplayHomeAsUpEnabled(true, br.com.uatizapi.messenger.R.drawable.ic_ab_back);
        } else {
