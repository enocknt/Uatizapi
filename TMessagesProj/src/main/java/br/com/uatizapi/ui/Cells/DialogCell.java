...
import br.com.uatizapi.android.Emoji;
...
public class DialogCell extends BaseCell {
    ...
    private void init() {
        ...
        if (lockDrawable == null) {
            lockDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.ic_lock_green);
        }

        if (checkDrawable == null) {
            checkDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.dialogs_check);
        }

        if (halfCheckDrawable == null) {
            halfCheckDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.dialogs_halfcheck);
        }
        ...
        if (errorDrawable == null) {
            errorDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.dialogs_warning);
        }

        if (countDrawable == null) {
            countDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.dialogs_badge);
        }

        if (groupDrawable == null) {
            groupDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.grouplist);
        }

        if (broadcastDrawable == null) {
            broadcastDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.broadcast);
        }
    ...
    private class DialogCellLayout {
        ...
        public void build(int width, int height) {
                ...
                if (printingString != null) {
                    ...
                    if (encryptedChat != null) {
                        ...
                        if (encryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
                            messageString = LocaleController.getString("EncryptionProcessing", br.com.uatizapi.messenger.R.string.EncryptionProcessing);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
                            if (user != null && user.first_name != null) {
                                messageString = LocaleController.formatString("AwaitingEncryption", br.com.uatizapi.messenger.R.string.AwaitingEncryption, user.first_name);
                            } else {
                                messageString = LocaleController.formatString("AwaitingEncryption", br.com.uatizapi.messenger.R.string.AwaitingEncryption, "");
                            }
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
                            messageString = LocaleController.getString("EncryptionRejected", br.com.uatizapi.messenger.R.string.EncryptionRejected);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
                            if (encryptedChat.admin_id == UserConfig.getClientUserId()) {
                                if (user != null && user.first_name != null) {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", br.com.uatizapi.messenger.R.string.EncryptedChatStartedOutgoing, user.first_name);
                                } else {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", br.com.uatizapi.messenger.R.string.EncryptedChatStartedOutgoing, "");
                                }
                            } else {
                                messageString = LocaleController.getString("EncryptedChatStartedIncoming", br.com.uatizapi.messenger.R.string.EncryptedChatStartedIncoming);
                            }
                        }
                    }
                }
                ...
                if (printingString != null) {
                    ...
                    if (message.messageOwner instanceof TLRPC.TL_messageService) {
                        ...
                        if (chat != null && chat.id > 0) {
                            String name = "";
                            if (message.isFromMe()) {
                                name = LocaleController.getString("FromYou", br.com.uatizapi.messenger.R.string.FromYou);
                            } else {
                                if (fromUser != null) {
            ...
            if (nameString.length() == 0) {
                nameString = LocaleController.getString("HiddenName", br.com.uatizapi.messenger.R.string.HiddenName);
            }
