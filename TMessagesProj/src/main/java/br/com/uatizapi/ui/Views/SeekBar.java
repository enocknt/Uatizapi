...
public class SeekBar {
    ...
    public SeekBar(Context context) {
        if (thumbDrawable1 == null) {
            thumbDrawable1 = context.getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.player1);
            thumbDrawablePressed1 = context.getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.player1_pressed);
            thumbDrawable2 = context.getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.player2);
            thumbDrawablePressed2 = context.getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.player2_pressed);
