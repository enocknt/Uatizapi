...
import br.com.uatizapi.ui.Views.GifDrawable;
...
public class ChatMediaCell extends ChatBaseCell implements MediaController.FileDownloadProgressListener {
    ...
    public ChatMediaCell(Context context) {
        ...
        if (placeholderInDrawable == null) {
            placeholderInDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photo_placeholder_in);
            placeholderOutDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photo_placeholder_out);
            placeholderDocInDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doc_blue);
            placeholderDocOutDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doc_green);
            buttonStatesDrawables[0] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photoload);
            buttonStatesDrawables[1] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photocancel);
            buttonStatesDrawables[2] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photogif);
            buttonStatesDrawables[3] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.playvideo);
            buttonStatesDrawables[4] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photopause);
            buttonStatesDrawables[5] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.burn);
            buttonStatesDrawables[6] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.circle);
            buttonStatesDrawables[7] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.photocheck);
            buttonStatesDrawablesDoc[0][0] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.docload_b);
            buttonStatesDrawablesDoc[1][0] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doccancel_b);
            buttonStatesDrawablesDoc[2][0] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.docpause_b);
            buttonStatesDrawablesDoc[0][1] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.docload_g);
            buttonStatesDrawablesDoc[1][1] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doccancel_g);
            buttonStatesDrawablesDoc[2][1] = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.docpause_g);
            videoIconDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.ic_video);
            docMenuInDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doc_actions_b);
            docMenuOutDrawable = getResources().getDrawable(br.com.uatizapi.messenger.R.drawable.doc_actions_g);
        ...
        if (currentMessageObject != messageObject || isPhotoDataChanged(messageObject) || isUserDataChanged()) {
            ...
            if (messageObject.type == 9) {
                ...
                if (name == null || name.length() == 0) {
                    name = LocaleController.getString("AttachDocument", br.com.uatizapi.messenger.R.string.AttachDocument);
                }
                int maxWidth;
