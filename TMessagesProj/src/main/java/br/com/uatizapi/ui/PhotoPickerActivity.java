...
public class PhotoPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container) {
        if (fragmentView == null) {
            ...
            actionBarLayer.setItemsBackground(br.com.uatizapi.messenger.R.drawable.bar_selector_picker);
            actionBarLayer.setDisplayUseLogoEnabled(true, br.com.uatizapi.messenger.R.drawable.gallery);
            actionBarLayer.setDisplayHomeAsUpEnabled(true, br.com.uatizapi.messenger.R.drawable.photo_back);
            actionBarLayer.setTitle(LocaleController.getString("Gallery", br.com.uatizapi.messenger.R.string.Gallery));
            ...
            menu.addItem(1, br.com.uatizapi.messenger.R.drawable.ic_ab_other_white2);

            fragmentView = inflater.inflate(br.com.uatizapi.messenger.R.layout.photo_picker_layout, container, false);
            ...
            emptyView.setText(LocaleController.getString("NoPhotos", br.com.uatizapi.messenger.R.string.NoPhotos));
            listView = (GridView)fragmentView.findViewById(br.com.uatizapi.messenger.R.id.media_grid);
            progressView = fragmentView.findViewById(br.com.uatizapi.messenger.R.id.progressLayout);

            Button cancelButton = (Button)fragmentView.findViewById(br.com.uatizapi.messenger.R.id.cancel_button);
            ...
            doneButton = fragmentView.findViewById(br.com.uatizapi.messenger.R.id.done_button);
    ...
    public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC.FileLocation fileLocation, int index) {
        ...
        for (int a = 0; a < count; a++) {
            ...
            BackupImageView imageView = (BackupImageView)view.findViewById(br.com.uatizapi.messenger.R.id.media_photo_image);
            if (imageView != null) {
                ...
                if (num == index) {
                    ...
                    View frameView = view.findViewById(br.com.uatizapi.messenger.R.id.photo_frame);
                    frameView.setVisibility(View.GONE);
                    ImageView checkImageView = (ImageView)view.findViewById(br.com.uatizapi.messenger.R.id.photo_check);
    ...
    private void updateSelectedCount() {
        if (selectedPhotos.isEmpty()) {
            ...
            doneButtonTextView.setCompoundDrawablesWithIntrinsicBounds(br.com.uatizapi.messenger.R.drawable.selectphoto_small_grey, 0, 0, 0);
    ...
    private void updateSelectedPhoto(View view, MediaController.PhotoEntry photoEntry) {
        ...
        ImageView checkImageView = (ImageView)view.findViewById(br.com.uatizapi.messenger.R.id.photo_check);
        if (selectedPhotos.containsKey(photoEntry.imageId)) {
            frameView.setBackgroundResource(br.com.uatizapi.messenger.R.drawable.photoborder);
            checkImageView.setImageResource(br.com.uatizapi.messenger.R.drawable.selectphoto_small_active);
            checkImageView.setBackgroundColor(0xff42d1f6);
        } else {
            frameView.setBackgroundDrawable(null);
            checkImageView.setImageResource(br.com.uatizapi.messenger.R.drawable.selectphoto_small);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                if (view == null) {
                    ...
                    view = li.inflate(br.com.uatizapi.messenger.R.layout.photo_picker_album_layout, viewGroup, false);
                }
                ...
                if (albumEntry.coverPhoto != null && albumEntry.coverPhoto.path != null) {
                    imageView.setImage("thumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, br.com.uatizapi.messenger.R.drawable.nophotos);
                } else {
                    imageView.setImageResource(br.com.uatizapi.messenger.R.drawable.nophotos);
                }
                TextView textView = (TextView)view.findViewById(br.com.uatizapi.messenger.R.id.album_name);
                ...
                textView = (TextView)view.findViewById(br.com.uatizapi.messenger.R.id.album_count);
                textView.setText("" + albumEntry.photos.size());
            } else if (type == 1) {
                if (view == null) {
                    LayoutInflater li = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    view = li.inflate(br.com.uatizapi.messenger.R.layout.photo_picker_photo_layout, viewGroup, false);
                    View checkImageView = view.findViewById(br.com.uatizapi.messenger.R.id.photo_check_frame);
                ...
                view.setTag(i);
                if (photoEntry.path != null) {
                    imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, br.com.uatizapi.messenger.R.drawable.nophotos);
                } else {
                    imageView.setImageResource(br.com.uatizapi.messenger.R.drawable.nophotos);
                }
                updateSelectedPhoto(view, photoEntry);
