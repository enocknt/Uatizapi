...
import br.com.uatizapi.ui.Views.VideoSeekBarView;
import br.com.uatizapi.ui.Views.VideoTimelineView;
...
public class VideoEditorActivity extends BaseFragment implements TextureView.SurfaceTextureListener {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container) {
        if (fragmentView == null) {
            ...
            actionBarLayer.setTitle(LocaleController.getString("EditVideo", br.com.uatizapi.messenger.R.string.EditVideo));
            ...
            View doneItem = menu.addItemResource(1, br.com.uatizapi.messenger.R.layout.group_create_done_layout);
            ...
            fragmentView = inflater.inflate(br.com.uatizapi.messenger.R.layout.video_editor_layout, container, false);
            originalSizeTextView = (TextView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.original_size);
            editedSizeTextView = (TextView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.edited_size);
            videoContainerView = fragmentView.findViewById(br.com.uatizapi.messenger.R.id.video_container);
            textContainerView = fragmentView.findViewById(br.com.uatizapi.messenger.R.id.info_container);
            controlView = fragmentView.findViewById(br.com.uatizapi.messenger.R.id.control_layout);
            compressVideo = (CheckBox) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.compress_video);
            compressVideo.setText(LocaleController.getString("CompressVideo", br.com.uatizapi.messenger.R.string.CompressVideo));
            ...
            TextView titleTextView = (TextView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.original_title);
            titleTextView.setText(LocaleController.getString("OriginalVideo", br.com.uatizapi.messenger.R.string.OriginalVideo));
            titleTextView = (TextView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.edited_title);
            titleTextView.setText(LocaleController.getString("EditedVideo", br.com.uatizapi.messenger.R.string.EditedVideo));

            videoTimelineView = (VideoTimelineView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.video_timeline_view);
                ...
                public void onLeftProgressChanged(float progress) {
                    ...
                    try {
                        if (videoPlayer.isPlaying()) {
                            videoPlayer.pause();
                            playButton.setImageResource(br.com.uatizapi.messenger.R.drawable.video_play);
                        }
            ...
            videoSeekBarView = (VideoSeekBarView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.video_seekbar);
            ...
            playButton = (ImageView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.play_button);
            ...
            textureView = (TextureView) fragmentView.findViewById(br.com.uatizapi.messenger.R.id.video_view);
