...
public class ContactsController {
    ...
    public void checkAppAccount() {
        ...
        Account[] accounts = am.getAccountsByType("org.com.account");
        ...
        if (recreateAccount) {
            ...
            if (UserConfig.isClientActivated()) {
                try {
                    currentAccount = new Account(UserConfig.getCurrentUser().phone, "org.com.account");
                ...
                if (pCur.getCount() > 0) {
                    while (pCur.moveToNext()) {
                        ...
                        if (type == ContactsContract.CommonDataKinds.Phone.TYPE_CUSTOM) {
                            ...
                            contact.phoneTypes.add(LocaleController.getString("PhoneHome", br.com.uatizapi.messenger.R.string.PhoneHome));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneMobile", br.com.uatizapi.messenger.R.string.PhoneMobile));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_WORK) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneWork", br.com.uatizapi.messenger.R.string.PhoneWork));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MAIN) {
                            contact.phoneTypes.add(LocaleController.getString("PhoneMain", br.com.uatizapi.messenger.R.string.PhoneMain));
                        } else {
                            contact.phoneTypes.add(LocaleController.getString("PhoneOther", br.com.uatizapi.messenger.R.string.PhoneOther));
                        }
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.com.messenger.android.profile");
