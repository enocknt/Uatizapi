...
public class LocaleController {
    ...
    public static String getCurrentLanguageName() {
        return getString("LanguageName", br.com.uatizapi.messenger.R.string.LanguageName);
    }
    ...
    public static String formatDate(long date) {
        ...
        if (dateDay == day && year == dateYear) {
            ...
            return getString("Yesterday", br.com.uatizapi.messenger.R.string.Yesterday);
    ...
    public static String formatDateOnline(long date) {
        ...
        if (dateDay == day && year == dateYear) {
            return String.format("%s %s %s", LocaleController.getString("LastSeen", br.com.uatizapi.messenger.R.string.LastSeen), LocaleController.getString("TodayAt", br.com.uatizapi.messenger.R.string.TodayAt), formatterDay.format(new Date(date * 1000)));
        } else if (dateDay + 1 == day && year == dateYear) {
            return String.format("%s %s %s", LocaleController.getString("LastSeen", br.com.uatizapi.messenger.R.string.LastSeen), LocaleController.getString("YesterdayAt", br.com.uatizapi.messenger.R.string.YesterdayAt), formatterDay.format(new Date(date * 1000)));
        } else if (year == dateYear) {
            String format = LocaleController.formatString("formatDateAtTime", br.com.uatizapi.messenger.R.string.formatDateAtTime, formatterMonth.format(new Date(date * 1000)), formatterDay.format(new Date(date * 1000)));
            return String.format("%s %s", LocaleController.getString("LastSeenDate", br.com.uatizapi.messenger.R.string.LastSeenDate), format);
        } else {
            String format = LocaleController.formatString("formatDateAtTime", br.com.uatizapi.messenger.R.string.formatDateAtTime, formatterYear.format(new Date(date * 1000)), formatterDay.format(new Date(date * 1000)));
            return String.format("%s %s", LocaleController.getString("LastSeenDate", br.com.uatizapi.messenger.R.string.LastSeenDate), format);
        }
    }
    ...
    public void recreateFormatters() {
        ...
        String formatString = getStringInternal("formatterMonth", br.com.uatizapi.messenger.R.string.formatterMonth);
        if (formatString == null || formatString.length() == 0) {
            formatString = "dd MMM";
        }
        formatterMonth = FastDateFormat.getInstance(formatString, locale);

        formatString = getStringInternal("formatterYear", br.com.uatizapi.messenger.R.string.formatterYear);
        if (formatString == null || formatString.length() == 0) {
            formatString = "dd.MM.yy";
        }
        formatterYear = FastDateFormat.getInstance(formatString, locale);

        formatString = getStringInternal("formatterYearMax", br.com.uatizapi.messenger.R.string.formatterYearMax);
        if (formatString == null || formatString.length() == 0) {
            formatString = "dd.MM.yyyy";
        }
        formatterYearMax = FastDateFormat.getInstance(formatString, locale);

        formatString = getStringInternal("chatDate", br.com.uatizapi.messenger.R.string.chatDate);
        if (formatString == null || formatString.length() == 0) {
            formatString = "d MMMM";
        }
        chatDate = FastDateFormat.getInstance(formatString, locale);

        formatString = getStringInternal("chatFullDate", br.com.uatizapi.messenger.R.string.chatFullDate);
        if (formatString == null || formatString.length() == 0) {
            formatString = "d MMMM yyyy";
        }
        chatFullDate = FastDateFormat.getInstance(formatString, locale);

        formatString = getStringInternal("formatterWeek", br.com.uatizapi.messenger.R.string.formatterWeek);
        if (formatString == null || formatString.length() == 0) {
            formatString = "EEE";
        }
        ...
        if (is24HourFormat) {
            formatString = getStringInternal("formatterDay24H", br.com.uatizapi.messenger.R.string.formatterDay24H);
        } else {
            formatString = getStringInternal("formatterDay12H", br.com.uatizapi.messenger.R.string.formatterDay12H);
        }
        if (formatString == null || formatString.length() == 0) {
            if (is24HourFormat) {
                formatString = "HH:mm";
    ...
    public static String formatUserStatus(TLRPC.User user) {
        if (user == null || user.status == null || user.status.expires == 0 || user instanceof TLRPC.TL_userDeleted || user instanceof TLRPC.TL_userEmpty) {
            return getString("Offline", br.com.uatizapi.messenger.R.string.Offline);
        } else {
            int currentTime = ConnectionsManager.getInstance().getCurrentTime();
            if (user.status.expires > currentTime) {
                return getString("Online", br.com.uatizapi.messenger.R.string.Online);
            } else {
                if (user.status.expires == -1) {
                    return getString("Invisible", br.com.uatizapi.messenger.R.string.Invisible);
                } else {
