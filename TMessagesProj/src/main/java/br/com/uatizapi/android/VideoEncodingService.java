...
public class VideoEncodingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (builder == null) {
            ...
            builder.setContentTitle(LocaleController.getString("AppName", br.com.uatizapi.messenger.R.string.AppName));
            builder.setTicker(LocaleController.getString("SendingVideo", br.com.uatizapi.messenger.R.string.SendingVideo));
            builder.setContentText(LocaleController.getString("SendingVideo", br.com.uatizapi.messenger.R.string.SendingVideo));
        }
        currentProgress = 0;
        builder.setProgress(100, currentProgress, currentProgress == 0);
