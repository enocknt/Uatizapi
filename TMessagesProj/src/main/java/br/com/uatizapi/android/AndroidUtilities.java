...
public class AndroidUtilities {
    ...
    public static int[] arrUsersAvatars = {
            br.com.uatizapi.messenger.R.drawable.user_red,
            br.com.uatizapi.messenger.R.drawable.user_green,
            br.com.uatizapi.messenger.R.drawable.user_yellow,
            br.com.uatizapi.messenger.R.drawable.user_blue,
            br.com.uatizapi.messenger.R.drawable.user_violet,
            br.com.uatizapi.messenger.R.drawable.user_pink,
            br.com.uatizapi.messenger.R.drawable.user_aqua,
            br.com.uatizapi.messenger.R.drawable.user_orange};

    public static int[] arrGroupsAvatars = {
            br.com.uatizapi.messenger.R.drawable.group_red,
            br.com.uatizapi.messenger.R.drawable.group_green,
            br.com.uatizapi.messenger.R.drawable.group_yellow,
            br.com.uatizapi.messenger.R.drawable.group_blue,
            br.com.uatizapi.messenger.R.drawable.group_violet,
            br.com.uatizapi.messenger.R.drawable.group_pink,
            br.com.uatizapi.messenger.R.drawable.group_aqua,
            br.com.uatizapi.messenger.R.drawable.group_orange};

    public static int[] arrBroadcastAvatars = {
            br.com.uatizapi.messenger.R.drawable.broadcast_red,
            br.com.uatizapi.messenger.R.drawable.broadcast_green,
            br.com.uatizapi.messenger.R.drawable.broadcast_yellow,
            br.com.uatizapi.messenger.R.drawable.broadcast_blue,
            br.com.uatizapi.messenger.R.drawable.broadcast_violet,
            br.com.uatizapi.messenger.R.drawable.broadcast_pink,
            br.com.uatizapi.messenger.R.drawable.broadcast_aqua,
            br.com.uatizapi.messenger.R.drawable.broadcast_orange};
    ...
    public static boolean isTablet() {
        if (isTablet == null) {
            isTablet = ApplicationLoader.applicationContext.getResources().getBoolean(br.com.uatizapi.messenger.R.bool.isTablet);
        }
        return isTablet;
    }
    ...
    public static int getUserAvatarForId(int id) {
        if (id / 1000 == 333 || id / 1000 == 777) {
            return br.com.uatizapi.messenger.R.drawable.telegram_avatar;
        }
    ...
    public static AlertDialog.Builder buildTTLAlert(final Context context, final TLRPC.EncryptedChat encryptedChat) {
        ...
        builder.setTitle(LocaleController.getString("MessageLifetime", br.com.uatizapi.messenger.R.string.MessageLifetime));
        ...
        numberPicker.setFormatter(new NumberPicker.Formatter() {
            ...
            public String format(int value) {
                if (value == 0) {
                    return LocaleController.getString("ShortMessageLifetimeForever", br.com.uatizapi.messenger.R.string.ShortMessageLifetimeForever);
